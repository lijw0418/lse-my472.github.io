...
```{r}
authentication <- list(consumer_key = "zSVt8aHab93P7aYgIPLLXpCLf",
                 consumer_secret = "xOd8TM5aIkUN1sBlnTiEuAmRFBMTAraNJUyOzjPfoWCaij7qyD",
                 access_token = "1453509153658396673-UGio02phSSKKbmD1dAL3zMyCcsQr4k",
                 access_token_secret = "dXKJBxzAKK9Ljmd1CN8aAg8AAhW6XHJBNK8UQxzPitbI6")
```
...
twitter_token <- create_token(app = "MY472 Week 5 lijw", 
...
# lookup_users("LSEnews", token=twitter_token)$screen_name
...
```{r}
stream_tweets(q = "", timeout = 30, file_name='streamed_tweets.json', token=twitter_token)
