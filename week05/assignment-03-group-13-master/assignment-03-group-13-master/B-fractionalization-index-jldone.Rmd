...
# Section 3. Visualize the language fractionalization in a plot chart 
figure <- ggplot(language_fract_range, aes(x=country_code, y=cumulative_deaths)) +
  geom_bar() + geom_text(hjust=-.1, size=3) + theme_minimal()
...
```{r}
fract <- read.csv('part_a_country_language_distribution.csv', stringsAsFactors=F, fileEncoding='UTF-8')
