...
```{r}
authentication <- list(consumer_key = "PGmuSJSwxhG8jcEDixzAT8Siv",
                 consumer_secret = "jZF0IC9Os6UZy2IZOoWNfkrMKOL9J5JbUIzYgBEotbGdhSJCgT",
                 access_token = "1453509153658396673-gpqR1ZdQJzfHoPLcVsWZjjLoEyNC7E",
                 access_token_secret = "BTcs2swJCetAiUXNnnND9mTNcKHO1upN2GF9NWZzCO4fW")
```
